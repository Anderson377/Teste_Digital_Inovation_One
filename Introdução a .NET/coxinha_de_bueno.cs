...
O restaurante especializado em coxinhas do pequeno distrito de 
Bueno de Andrada, interior de São Paulo, organiza essa competição 
...
sobre a competição, como o número de coxinhas consumidas pelos 
...
na competição, o dono do restaurante precisa que você desenvolva 
um programa para saber a quantidade média de coxinha que os 
...
indicando respectivamente o número total de coxinhas consumidas e o 
